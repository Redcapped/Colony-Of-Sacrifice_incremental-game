export function getDefaultGameData() {
  return {
    ...
    sacrifice:{unlocked:false, cooldownMult:1, cooldownAdd:0 ,durationMult:1, durationAdd:0, globalLevel:1,
      types:{
        ...
        fish:   {unlocked:false, effectType:'bonusProdMul',targetResource: 'water', level:1,levelMax:1,cooldown:60 , duration:60, baseAntcost:1,  baseBloodcost:5,  baseEffect:1.2, effectText:'times increase to water production',   lastUse:0,isOnCooldown:false,tooltipText:'Sacrifice ant to gain water production'},
        owl:    {unlocked:false, effectType:'bonusMaxMul',targetResource: 'science', level:1,levelMax:1,cooldown:120 , duration:120, baseAntcost:2,  baseBloodcost:15, baseEffect:2,   effectText:'times increase to max knowlage',     lastUse:0,isOnCooldown:false,tooltipText:'Sacrifce ant to gain max science'},
        rabbit: {unlocked:false, effectType:'breedingSpeed',targetResource: NaN, level:1,levelMax:1,cooldown:120 , duration:120, baseAntcost:2,  baseBloodcost:15, baseEffect:2,   effectText:'times increase to breeding speed',   lastUse:0,isOnCooldown:false,tooltipText:'Sacrifce ant to gain breeding speed'},
        beaver: {unlocked:false, effectType:'bonusProdMul',targetResource: 'wood', level:1,levelMax:1,cooldown:120 , duration:120, baseAntcost:2,  baseBloodcost:15, baseEffect:2,   effectText:'times increase to wood production',  lastUse:0,isOnCooldown:false,tooltipText:'Sacrifce ant to gain wood production'}
      },
      activeSacrifices:[]
